          ...
          messages: [
            {
              ...
              content: [
                ...
                "1) Prioriza SIEMPRE primero despachar desde las EXTRACTORAS la materia prima con acidez mas alta hacia la refineria (la acidez alta degrada la calidad y es urgente). El PUERTO tambien puede abastecer a la refineria como origen.",
                ...
                "3) Valida que el material entrante (incomingByProduct: proveedores, importaciones y transito) tenga donde almacenarse, ya sea en extractoras o en el PUERTO (puertoFreeCapacity, total y por producto). Si una extractora o el puerto del mismo producto esta copado y viene material entrante, sugiere despachar ese nodo hacia la refineria para LIBERAR espacio y que el entrante pueda almacenarse, aunque su acidez no sea la mas alta.",
                ...
                "Equilibra calidad (acidez) y espacio (liberar nodos copados para el entrante) sin exceder la capacidad de la refineria.",
