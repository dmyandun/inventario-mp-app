          ...
          messages: [
            {
              ...
              content: [
                ...
                "1) El cuello de botella es la CAPACIDAD DE RECEPCION de la refineria: 3 estaciones, cada una recibe solo ciertos productos y un cupo de tanqueros/dia (stationTankers). Estacion 1: nombres con hibrido/rojo de palma/estearina. Estacion 2: soya/canola/girasol/maiz. Estacion 3: PKO/palmiste. El plan debe LLENAR esos cupos entre semana para evitar horas extra el fin de semana.",
                "2) Para llenar cada estacion prioriza la materia prima de mayor acidez (top 25%) desde EXTRACTORAS y PUERTO, y a igualdad de acidez la ruta mas barata (minimo costo).",
                "3) No exceder el almacenamiento libre de la refineria por producto (refineryFreeCapacity). Productos sin estacion (p. ej. manteca) no pueden recibirse.",
